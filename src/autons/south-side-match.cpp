...
void new_south()
{
    ...
    chassis.turnToPoint(-24, 50, 1000, {.maxSpeed=70}, false);
    chassis.moveToPoint(-24, 50, 1500, {.maxSpeed=80}, false);
...
void new_red_south()
{
    ...
    // Score first ring
    intake.move_velocity(600);
    chassis.turnToPoint(20, 55, 1000, {.maxSpeed=70}, false);
    chassis.moveToPoint(20, 55, 1500, {.maxSpeed=80}, false);
}
